...
public class dreamloLeaderBoard : MonoBehaviour {
	...
	{
		highScores = "";
		WWW www = new WWW(dreamloWebserviceURL +  publicCode  + "/pipe-get/" + WWW.EscapeURL(GameController.gameController.CurrentBossName));
		yield return www;
		highScores = www.text;
    ...
    {
        Debug.Log("GettingScores");
        highScores = "";
        WWW www = new WWW(dreamloWebserviceURL + publicCode + "/xml/10");
        yield return www;
        highScores = www.text;
    }
